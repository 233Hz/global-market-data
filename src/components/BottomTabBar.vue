<template>
  <nav class="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#0a0a0b]/95 backdrop-blur-sm border-t border-white/10 px-2 py-1.5">
        ...
        <div class="relative">
          <component
            ...
            :class="[
              ...
              activeTab === tab.key ? 'text-[#8b5cf6]' : 'text-zinc-500'
            ]"
          />
        </div>
        <span
          :class="[
            ...
            activeTab === tab.key ? 'font-medium text-white' : 'font-normal text-zinc-500'
          ]"
        >
          {{ tab.label }}
        </span>
